...
App version: 1.0.13 / version code 26
Screenshots: English, Hindi, German, Russian, Simplified and Traditional Chinese 1.0.13 release UI (stored in the 1.0-beta.6 folder for stable URLs).

Open index.html to preview the English, Hindi, German, Russian and Chinese resources offline.
...
- 01 through 10 screenshots: 1080 x 1920, 24-bit PNG without transparency
- Screens: Mental Sky, onboarding feeling, exercises, exercise cards, journal, emotion log, audio player, Live Coach voice call, coach chat, personalization
